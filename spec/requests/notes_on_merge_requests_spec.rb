...
describe "On a merge request", js: true do
  ...
  describe "the note form" do
    ...
    it { within(".js-main-target-form") { should have_checked_field("Users involved") } }
...
describe "On a merge request diff", js: true, focus: true do
  ...
  describe "when adding a note" do
    ...
    describe "the note form" do
      ...
      it { should_not have_checked_field("Notify team via email") }
      it { should have_checked_field("Users involved") }
